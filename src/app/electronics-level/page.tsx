...
import CityCenterPriceChart from "@/components/Projects/CityCenter/CityCenterPriceChart";
...
const ElectronicsLevel = () => {
  ...
  return (
    <div className="page" dir="rtl">
      ...
      <CityCenterPriceChart description="رسم بياني يوضح ارتفاع سعر المتر في دور الإلكترونيات بسيتي سنتر المنصورة" />
