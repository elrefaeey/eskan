...
import { GALLERY_GROUND_STATS, GALLERY_GROUND_UNITS_SECTION_ID } from "@/features/gallery-ground/constants";
  ...
  return (
    <main className="w-full page" dir="rtl">
      ...
      <div className="container mx-auto">
        <StatsGrid stats={GALLERY_GROUND_STATS} colorScheme="primary" className="sec-padding mb-0" />
