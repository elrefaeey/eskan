...
import { GPI_IMAGES } from "@/features/gpi/constants";
  ...
  return (
    <main className="page" dir="rtl">
      ...
      <div className="container mx-auto">
        ...
        <AnimateInView className="mb-10 grid grid-cols-1 md:grid-cols-2 gap-6 bg-[#f8f8f8] rounded-2xl p-4 md:p-8 border border-gray-100 items-stretch">
          <div className="flex flex-col gap-4 order-2 md:order-1">
            <h2 className="text-primary text-2xl md:text-3xl font-extrabold mb-2">لماذا معهد إعداد الخريجين؟</h2>
            <p className="text-[#555] text-body-base md:text-lg mb-2">لأن السوق لا يحتاج إلى شهادات فقط... بل يحتاج إلى مهارات حقيقية.</p>
