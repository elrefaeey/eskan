...
import type { MadinaProjectCardData } from "../constants";

interface MadinaProjectCardProps {
  card: MadinaProjectCardData;
}

export default function MadinaProjectCard({ card }: MadinaProjectCardProps) {
  ...
  return (
    <div
      ...
      className={`cursor-pointer flex h-full flex-col ${card.cardBg} border-2 ${card.border} rounded-2xl p-6 gap-5 shadow-md hover:shadow-lg transition-shadow duration-200`}
    >
