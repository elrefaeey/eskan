...
function ElbadryTradePage() {
  ...
  const videoLink =
    videoLinks?.find((l) => l.name === ELBADRY_TRADE_HERO.videoLinkName)
      ?.link || ELBADRY_TRADE_HERO.defaultVideoId;
  const constructionSliderImages =
    constructionImages?.map((img) => img.img) || [];
  ...
  return (
    <div className="w-full page" >
      <ProjectHero
        ...
        images={headerImages}
        badge={{
          text: ELBADRY_TRADE_HERO.badge,
          className: ELBADRY_TRADE_HERO.badgeClassName,
        }}
      ...
      <div className="container mx-auto">
        ...
        <ProjectTour3DSection
          src={MALL_TOUR_3D.src}
          iframeTitle={MALL_TOUR_3D.title}
        />
