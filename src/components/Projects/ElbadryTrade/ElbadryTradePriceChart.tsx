...
const data = [
  { year: "2022", price: 50000, label: "50k", growth: null },
  { year: "2023", price: 55000, label: "55k", growth: "10%+" },
  { year: "2024", price: 60000, label: "60k", growth: "20%+" },
  { year: "2025", price: 65000, label: "65k", growth: "30%+" },
  { year: "2026", price: 75000, label: "75k", growth: "50%+" },
];
    ...
    >
      ...
      <div className="bg-gradient-to-l from-primary to-[#2d8a57] px-5 md:px-8 py-5">
        ...
        <p className="text-white/60 text-xs md:text-sm mt-1">
          السعر بالألف جنيه مع تقدم مراحل الإنشاء
        </p>
      </div>
      ...
      <div className="grid grid-cols-5 border-t border-gray-100">
        {[...data].reverse().map((row, i) => (
          ...
          >
            ...
            <span className="text-gray-500 text-xs">{row.year}</span>
            {row.growth && (
