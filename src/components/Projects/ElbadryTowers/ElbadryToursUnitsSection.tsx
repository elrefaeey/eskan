  ...
  return (
    <div className="sec-padding">
      ...
      >
        <SelectInput
          name="block_id"
          options={[{ value: "", label: "إعادة تعيين" }, ...blocks]}
          placeholder="البلوك"
        ...
        {blockId && (
          <>
            <SelectInput
              name="level_id"
              options={[{ value: "", label: "إعادة تعيين" }, ...levels]}
              placeholder="الدور"
              className="w-full md:w-[130px]"
      ...
      {units && units.length > 0 && (
        ...
        >
          <HiBellAlert className="text-2xl text-[#364138] font-semibold italic mt-1 relative z-50" />
